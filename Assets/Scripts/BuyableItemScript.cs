...
public class BuyableItemScript : MonoBehaviour 
{
	...
	{
		if (GameManager.instanceGM.playerObj.GetComponent<PlayerGoldScript> ().ActualGold >= itemPrice && !GameManager.instanceGM.playerObj.GetComponent<PlayerIGManager>().isDead) 
		{
